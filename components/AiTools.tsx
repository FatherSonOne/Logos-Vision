...
const GenericIcon: React.FC<{ letter: string; name: string }> = ({ letter, name }) => {
    const colors = [
...
const ToolLinkCard: React.FC<{ name: string; description: string; url: string; }> = ({ name, description, url }) => {
    const [iconError, setIconError] = useState(false);
    let hostname: string;
    try {
        hostname = new URL(url).hostname;
    } catch (e) {
        hostname = url; // Fallback for invalid URLs
    }
        ...
        >
            <div className="flex items-center gap-3">
                <div className="w-8 h-8 flex-shrink-0 flex items-center justify-center">
                    {iconError ? (
                        <GenericIcon letter={letter} name={name} />
                    ) : (
                        <img 
                            src={iconUrl} 
                            alt={`${name} logo`} 
...
const workflowTools = [
    { name: 'Gamma.app', description: 'AI-powered tool for creating engaging presentations, documents, and webpages.', url: 'https://gamma.app/' },
    { name: 'Claude.ai', description: 'A next-generation AI assistant for your tasks, no matter the scale.', url: 'https://claude.ai/' },
    { name: 'Perplexity.ai', description: 'An AI search engine that provides direct, cited answers to complex questions.', url: 'https://www.perplexity.ai/' },
    { name: 'Veed.io', description: 'Online video suite with AI features for subtitling, editing, and content creation.', url: 'https://www.veed.io/' },
    { name: 'Notion AI', description: 'Integrate AI assistance directly into your notes, docs, and project management.', url: 'https://www.notion.so/product/ai' },
    { name: 'Midjourney', description: 'An independent research lab producing a proprietary artificial intelligence program that creates images from textual descriptions.', url: 'https://www.midjourney.com/' },
    { name: 'ElevenLabs', description: 'Generate high-quality spoken audio in any voice, style, and language.', url: 'https://elevenlabs.io/' },
    { name: 'Tome', description: 'The AI-powered storytelling format for presentations and documents.', url: 'https://tome.app/' },
    { name: 'Jasper.ai', description: 'AI Content Platform that helps your team create content tailored for your brand.', url: 'https://www.jasper.ai/' },
    { name: 'Fireflies.ai', description: 'AI assistant for your meetings. Record, transcribe, and search your conversations.', url: 'https://fireflies.ai/' },
    { name: 'DALL-E 3', description: 'Create highly detailed images from text descriptions using OpenAI\'s advanced model.', url: 'https://openai.com/dall-e-3' },
    { name: 'Synthesia', description: 'Create professional videos with AI avatars and voiceovers from just text.', url: 'https://www.synthesia.io/' },
    { name: 'RunwayML', description: 'An applied AI research company shaping the next era of art, entertainment and human creativity.', url: 'https://runwayml.com/' },
    { name: 'Zapier', description: 'Automate workflows by connecting your apps and services with AI-powered triggers.', url: 'https://zapier.com/' },
    { name: 'Consensus', description: 'An AI search engine for research papers, extracting and distilling scientific findings.', url: 'https://consensus.app/' },
    { name: 'NotebookLM', description: 'Google\'s AI research and writing assistant for your source materials.', url: 'https://notebooklm.google.com/' },
    { name: 'Google Colab', description: 'Collaborative notebooks for AI/ML development, running in the cloud.', url: 'https://colab.research.google.com/' },
    { name: 'Hugging Face', description: 'The AI community building the future. Find models, datasets, and applications.', url: 'https://huggingface.co/' },
    { name: 'Kaggle', description: 'A community for data scientists and ML practitioners. Access datasets and notebooks.', url: 'https://www.kaggle.com/' },
    { name: 'Replicate', description: 'Run and fine-tune open-source AI models with a cloud API.', url: 'https://replicate.com/' },
];

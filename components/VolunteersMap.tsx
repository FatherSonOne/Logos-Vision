...
const GOOGLE_MAPS_API_KEY = "AIzaSyArmLqdBGYQv8l2N8Ya3jte42dUfK829OI";
...
export const VolunteersMap: React.FC<VolunteersMapProps> = ({ volunteers, clients, selectedClientId }) => {
    ...
    useEffect(() => {
        if (map && infoWindow) {
            ...
            // FIX: Add an explicit type annotation for the Google Maps Marker object to resolve a TypeScript error where the type was inferred as 'unknown'.

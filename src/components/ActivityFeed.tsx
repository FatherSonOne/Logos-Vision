...
import { PlusIcon, PhoneIcon, MailIcon, UsersIcon, DocumentTextIcon, PencilIcon, TrashIcon, ClipboardListIcon } from './icons';
            ...
            <div className="space-y-6">
                {filteredActivities.length > 0 ? (
                    ...
                    <EmptyState
                        ...
                        message="Try adjusting your filters or log a new call, meeting, or note."

...
export const DocumentLibrary: React.FC<DocumentLibraryProps> = ({ documents, clients, projects, teamMembers, onUploadDocument }) => {
        ...
        <div>
            ...
            {filteredDocuments.length > 0 ? (
                ...
                <EmptyState
                    ...
                    message="Upload a document to get started organizing your files."

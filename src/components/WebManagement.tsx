...
import { GlobeIcon, PlusIcon, EyeIcon, PencilIcon, ArchiveIcon } from './icons';
            ...
            {filteredWebpages.length > 0 ? (
                <div className="bg-white rounded-lg shadow-sm border border-slate-200 overflow-x-auto">
                 ...
                 <EmptyState
                    ...
                    message="Create a new webpage to manage client-facing content."
                    actionText="Create New Page"
